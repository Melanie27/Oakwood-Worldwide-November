								...
								<section class="header-overlay col-sm-12 col-xs-12">
									...
									<section class="teasers col-md-4">
										<ul class="news-thumbnails">
											<li class="clearfix">
												<span class="half">
												<img src="images/news/latest-news-tb-01.jpg" alt="latest-news-tb-01" class="pull-left img-responsive">
												</span>
												<span class="half" >
				...
				<div class="content row">
					<div class="col-lg-12">
						<section class="clearfix news-topics">
							<section class="three">
								<div class="container">
									<section class="col-md-4 press-room col-sm-12 col-xs-12">
									...
									<section class="col-md-4 in-the-news col-sm-12 col-xs-12">
										...
										<section class="latest-releases">
											<h3>Latest Releases</h3>
												<ul class="news-thumbnails">
													<li class="clearfix">
														<img src="images/news/in-news-tb-01.jpg" alt="In the News 1" class="pull-left">
														<p class="date">Oct 5, 2013</p>
														<p class="headline">Lorem Ipsum Dolore Sit Amet Oakwood</p>
													</li>
													<li class="clearfix">
														<img src="images/news/in-news-tb-02.jpg" alt="In the News 2" class="pull-left">
														<p class="date">Oct 5, 2013</p>
														<p class="headline">Lorem Ipsum Dolore Sit Amet Oakwood</p>
													</li>		
												</ul>	
									...
									<section class="col-md-4 press-third-col col-sm-12 col-xs-12">
